...
public class Debugger2{
	...
	public IDEX idex;
	public EXMEM exmem;
	public HazardMux hzrd;
	public String output = "";
	public FileWriter fstream;
	public BufferedWriter out;
	
	public Debugger2(RegisterFile regFile, Decode decode,
		...
		try {
			fstream = new FileWriter("debugPipeline.txt", false);
			out = new BufferedWriter(fstream);
			out.write("");
			out.close();
			fstream = new FileWriter("debugPipeline.txt", true);
			out = new BufferedWriter(fstream);
		} catch (IOException e) {
	...
	public void debugCycle(float cycleCount, String stage){
		...
		if(stage.equals("Decode")){
			...
			output += "#------------------------------- Hazard Mux --------------------------#\n";				
			output += "# Jump:" + print(hzrd.jump) + "\n";
			output += "# RegDST:" + print(hzrd.regDST) + "\n";
			output += "# Branch:" + print(hzrd.branch) + "\n";
			output += "# MemRead:" + print(hzrd.memRead) + "\n";
			output += "# MemToReg:" + print(hzrd.memToReg) + "\n";
			output += "# ALUOp:" + print(hzrd.aluOp) + "\n";
			output += "# MemWrite:" + print(hzrd.memWrite) + "\n";
			output += "# ALUSrc:" + print(hzrd.aluSrc) + "\n";
			output += "# RegWrite:" + print(hzrd.regWrite) + "\n";
			output += "# JumpReg:" + print(hzrd.jumpReg) + "\n";
			output += "# branchBNE:" + print(hzrd.branchBNE) + "\n";
			output += "# Branch Taken:" + print(hzrd.branchTaken) + "\n";
		...
		if(stage.equals("Execute")){
			...
			output += "#-------------------------- General ALU Information --------------------#\n";				
		...
		if(stage.equals("Memory")){
			...
			output += "#--------------------------- BranchMux And Information ----------------#\n";	
		...
		if(stage.equals("Writeback")){
			output += "........................................................................\n";
			output += ".                              Cycle " + new Float(cycleCount).intValue() +"                                 .\n";
			output += "........................................................................\n\n";
			output += "########################################################################\n";
			output += "#                         STAGE = WRITEBACK                            #\n";
			output += "#                                                                      #\n";
			output += "#------------------------------ memToRegMux ---------------------------#\n";
