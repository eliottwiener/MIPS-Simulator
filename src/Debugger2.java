...
public class Debugger2{
	...
	public Debugger2(RegisterFile regFile, Decode decode,
		...
		try {
			fstream = new FileWriter("debug2.txt", false);
			out = new BufferedWriter(fstream);
			out.write("");
			out.close();
			fstream = new FileWriter("debug2.txt", true);
			out = new BufferedWriter(fstream);
		} catch (IOException e) {
	...
	public void debugCycle(int cycleCount, String stage){
